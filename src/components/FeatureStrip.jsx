...
/**
 * FeatureStrip component - Displays key platform features
 */
export default function FeatureStrip() {
  return (
    <section id="skills" className="feature-strip" aria-labelledby="skills-heading">
      <div className="container">
        <div className="feature-strip-inner reveal">
          {features.map((feature) => (
            <div key={feature.title} className="strip-item">
              <div className="strip-icon" aria-hidden="true">{feature.icon}</div>
